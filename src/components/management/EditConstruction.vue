<template>
  <div class="panel-container">
    ...
    <form class="flex flex-col gap-6 lg:flex-row lg:items-end" @submit.prevent="">
      <div class="flex w-full flex-col lg:w-auto">
        ...
        <div class="flex flex-wrap gap-2">
          <span
            ...
            :key="item"
            class="inline-flex items-center rounded-full bg-blue-100 px-3 py-1.5 text-sm font-medium text-blue-800 dark:bg-blue-900 dark:text-blue-100"
          >
            {{ item }}
            <button
